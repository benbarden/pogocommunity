...
class PokedexPopulate extends Migration
{
    ...
    public function up()
    {
        ...
        DB::insert($insertSql." VALUES('377', 'Regirock', 3, 1, 0, 1, 0, 20, 0, NOW(), NOW())");
        DB::insert($insertSql." VALUES('378', 'Regice', 3, 1, 0, 1, 0, 20, 0, NOW(), NOW())");
        DB::insert($insertSql." VALUES('379', 'Registeel', 3, 1, 0, 1, 0, 20, 0, NOW(), NOW())");
        DB::insert($insertSql." VALUES('380', 'Latias', 3, 1, 0, 1, 0, 20, 1, NOW(), NOW())");
        DB::insert($insertSql." VALUES('381', 'Latios', 3, 1, 0, 1, 0, 20, 1, NOW(), NOW())");
        DB::insert($insertSql." VALUES('382', 'Kyogre', 3, 1, 0, 1, 0, 20, 1, NOW(), NOW())");
        DB::insert($insertSql." VALUES('383', 'Groudon', 3, 1, 0, 1, 0, 20, 1, NOW(), NOW())");
        DB::insert($insertSql." VALUES('384', 'Rayquaza', 3, 1, 0, 1, 0, 20, 1, NOW(), NOW())");
        ...
        DB::insert($insertSql." VALUES('480', 'Uxie', 4, 1, 1, 1, 0, 20, 0, NOW(), NOW())");
        DB::insert($insertSql." VALUES('481', 'Mesprit', 4, 1, 1, 1, 0, 20, 0, NOW(), NOW())");
        DB::insert($insertSql." VALUES('482', 'Azelf', 4, 1, 1, 1, 0, 20, 0, NOW(), NOW())");
