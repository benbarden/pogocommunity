...
sudo cp /vagrant/vagrant-deploy/apache2/pogocomm-local.conf /etc/apache2/sites-available
sudo a2ensite pogocomm-local
...
mysql -u root -ppass -e "create database pogocomm;"
mysql -u root -ppass -e "create user 'pogocomm'@'localhost' identified by 'pass';"
